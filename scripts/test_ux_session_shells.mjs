...
assertContains(hostContent, 'TTS: {facilitatorVoiceGenderLabel}', 'host header surfaces the selected TTS voice gender');
...
assertContains(hostMessagingView, 'TTS: {facilitatorVoiceGenderLabel}', 'host command center repeats only the TTS gender needed for voice selection');
