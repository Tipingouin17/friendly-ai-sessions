...
const PricingFeatureValue = ({ value }: { value: boolean | string | number | null | undefined }) => {
...
const EnterprisePlanCard = ({ onContactClick }: { onContactClick: () => void }) => (
...
const StandardPlanCard = ({ plan }: { plan: Plan }) => (
  <div 
