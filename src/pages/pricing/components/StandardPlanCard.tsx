...
export const StandardPlanCard = ({
  ...
  const getFeatureList = () => {
    ...
    if (plan.plan_table_details.no_of_facilitator) {
      ...
      const isUnlimited = typeof plan.plan_table_details.no_of_facilitator === 'number' && plan.plan_table_details.no_of_facilitator > 999999 || plan.plan_table_details.no_of_facilitator === 'unlimited';
    ...
    if (plan.plan_table_details.no_of_sessions) {
      // Check if it's a numeric value greater than 999999 or explicitly "unlimited"
      const isUnlimited = typeof plan.plan_table_details.no_of_sessions === 'number' && plan.plan_table_details.no_of_sessions > 999999 || plan.plan_table_details.no_of_sessions === 'unlimited';
    ...
    if (plan.plan_table_details.max_participants) {
      // Check if it's a numeric value greater than 999999 or explicitly "unlimited"
      const isUnlimited = typeof plan.plan_table_details.max_participants === 'number' && plan.plan_table_details.max_participants > 999999 || plan.plan_table_details.max_participants === 'unlimited';
    ...
    if (plan.plan_table_details.number_of_questions_per_session) {
      // Check if it's a numeric value greater than 999999 or explicitly "unlimited"
      const isUnlimited = typeof plan.plan_table_details.number_of_questions_per_session === 'number' && plan.plan_table_details.number_of_questions_per_session > 999999 || plan.plan_table_details.number_of_questions_per_session === 'unlimited';
