...
export async function processResponse(
  ...
  try {
    ...
    if (sessionStart) {
      ...
      console.log(`✅ [${requestId}] [AI-TRACKING] Session start acknowledged - database trigger will generate welcome message`);
      console.log(`📊 [${requestId}] [AI-TRACKING] Session context for database trigger:`, {
        conversationId,
        hasRichContext: !!(conversation?.sessions?.facilitator_details?.title && conversation?.sessions?.objective),
